...
public class EmailReport {
    ...
    public static void sendReportEmail(int passed, int failed, int skipped) {
        ...
        try {
            ...
            String subject = "📢Hurray! Dataglance Automation Test Execution Report is Ready to View 📊";
            ...
            String bodyText = "<html><body style='font-family:Arial, sans-serif;'>"
                    ...
                    + "<p>The latest Automated TestSuite has been executed. Please find the summary below, along with the detailed HTML report for further insights.</p>"
                    ...
                    + "    <td style='padding:8px;'>34 Region</td>"
                    + "  </tr>"
                    + "  <tr>"
